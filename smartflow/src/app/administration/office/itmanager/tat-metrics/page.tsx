...
export default function ITManagerTATHub() {
  return (
        ...
        <div className="flex">
          ...
          <main className="flex-1 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Link href="/administration/office/itmanager/tat-metrics/tickets" className="group block p-6 bg-white rounded-xl shadow-lg border border-slate-200 hover:shadow-xl transition">
              ...
              <Link href="/administration/office/itmanager/tat-metrics/access-requests" className="group block p-6 bg-white rounded-xl shadow-lg border border-slate-200 hover:shadow-xl transition">
                <div className="flex items-center">
              ...
              <Link href="/administration/office/itmanager/tat-metrics/users" className="group block p-6 bg-white rounded-xl shadow-lg border border-slate-200 hover:shadow-xl transition">
                <div className="flex items-center">
