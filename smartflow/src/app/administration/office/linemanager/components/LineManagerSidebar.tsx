          ...
          <div className="flex items-start flex-1 min-w-0">
            ...
            {!isCollapsed && (
              <div className="ml-4 flex-1 min-w-0">
                <h2 className="text-lg font-bold text-slate-900 tracking-tight break-words leading-tight">Line Manager</h2>
                <p className="text-sm text-slate-500 font-medium break-words leading-tight mt-1">{user?.department}</p>
              </div>
            )}
          </div>
