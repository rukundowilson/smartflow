...
export default function ITHODTATHub() {
  return (
        ...
        <div className="flex">
          ...
          <main className="flex-1 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Link href="/administration/it-hod/tat-metrics/tickets" className="group block p-6 bg-white rounded-xl shadow-lg border border-slate-200 hover:shadow-xl transition">
              ...
              <Link href="/administration/it-hod/tat-metrics/access-requests" className="group block p-6 bg-white rounded-xl shadow-lg border border-slate-200 hover:shadow-xl transition">
                <div className="flex items-center">
              ...
              <Link href="/administration/it-hod/tat-metrics/users" className="group block p-6 bg-white rounded-xl shadow-lg border border-slate-200 hover:shadow-xl transition">
                <div className="flex items-center">
