...
const ITManagerApprovalsDashboard = () => {
  const { user } = useAuth();
  ...
  // Load pending IT Manager requests
  useEffect(() => {
  ...
  const handleApprove = async (approvalData: ApprovalData) => {
    ...
    try {
      ...
      alert('Access request approved! Access has been granted to the user.');
    } catch (error) {
      console.error('Error approving request:', error);
    ...
    return (
      <div className="flex items-center justify-center py-16">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading IT Manager approvals...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Final approval for access requests</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200 bg-gray-50">
            <h2 className="text-lg font-semibold text-gray-900">Pending Final Approvals</h2>
          </div>

          {requests.length === 0 ? (
            <div className="p-8 text-center">
              <Building className="h-12 w-12 text-gray-400 mx-auto mb-4" />
              <h3 className="text-lg font-medium text-gray-900 mb-2">No pending final approvals</h3>
              <p className="text-gray-500">All requests have been processed or are still with previous approvers</p>
            </div>
          ) : (
...
export default ITManagerApprovalsDashboard; 